...
import com.daobao.asus.dbbaseframe.netUtil.CallBack.RequestCallbacks;
import com.daobao.asus.dbbaseframe.netUtil.DownLoad.DownLoadHandler;
import java.io.File;
...
/**
 * 最终我们可以通过RestClient类的builder()方法
 * 获取RestClientBuilder直接构造网络请求
 *
